...
public class RMIServer {
    ...
    public static class MPIProxy {
        ...
        public static void Recv(final Object buf, final int offset, final int len, final Datatype datatype, final int source, final int tag) throws MPIException {
            invoke(() -> MPI.COMM_WORLD.Recv(buf, offset, len, datatype, source, tag));
        }
